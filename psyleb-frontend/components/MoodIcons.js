...
const MoodIcons = () => {
  return (
    <View style={styles.container}>
        ...
        <TouchableOpacity>
        <MaterialIcons name="sentiment-satisfied-alt" size={50} color="#75E265" 
        />
        ...
        <TouchableOpacity>
        <MaterialIcons name="sentiment-very-dissatisfied" size={50} color="#FF874D" />
        <Text style={styles.text}>Bad</Text>
        </TouchableOpacity>
        <TouchableOpacity>
        <FontAwesome5 name="sad-cry" size={50} color="#FE626B" />
